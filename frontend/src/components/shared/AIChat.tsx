...
const AIChat = () => {
  ...
  const getFallbackResponse = (question: string, lang: string): string => {
    ...
    if (q.includes('program') || q.includes('curriculum') || q.includes('grade')) {
      return "KCS offers:\n• Kindergarten: faith and knowledge for young learners\n• Elementary: strong academic foundation and spiritual growth\n• Middle School: academic growth, biblical principles, and character\n• High School: rigorous academics and Christ-centered leadership preparation."
    }
